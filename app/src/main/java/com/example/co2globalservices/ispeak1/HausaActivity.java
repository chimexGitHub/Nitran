...
public class HausaActivity extends AppCompatActivity {
    ...
    // create and setup the {@link audioManager} to request audio focus
        ...
        words.add(new Word("Ten","Goma",R.raw.record038));
        words.add(new Word("House","Gida",R.raw.record039));
        words.add(new Word("My friend","Aboki na",R.raw.record040));
        words.add(new Word("Friend","Aboki",R.raw.record041));
        words.add(new Word("Mosque","Masalasi",R.raw.record042));
        words.add(new Word("#5( five naira)","Naira biyar",R.raw.record043));
        words.add(new Word("#10( ten naira)","Naira doma",R.raw.record044));
        words.add(new Word("#20(twenty naire)","Naira ishinrin",R.raw.record045));
        words.add(new Word("#50(fifty naira)","Naira amsin",R.raw.record046));
        words.add(new Word("#100(one hundred naira)","Naira dari",R.raw.record047));
        words.add(new Word("#200(two hundred naira)","Naira deri biwu",R.raw.record048));
        words.add(new Word("#500(five hundred naira)","Naira deri biyar",R.raw.record049));
        words.add(new Word("#1000(0ne thousand naira)","Naira dubu",R.raw.record050));
        words.add(new Word("Thankyou","Nagode",R.raw.record050));  //remember to look it out, 50 appears twice
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED){
                    ...
                    mMediaPlayer= MediaPlayer.create(HausaActivity.this,word.getAudioResourceId());
